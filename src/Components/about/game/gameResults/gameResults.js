            ...
            {isShow && (
                <>
                    ...
                    <button
                        className="gameButton"
                        type="button"
                        data-testid="lizardButton"
                        onClick={() => checkResult(choicesList[3].id)}
                    >
                        <img
                            className="gameImg"
                            src={choicesList[3].imageUrl}
                            alt={choicesList[3].id}
                            key={choicesList[3].id}
                        />
                    </button>
                    <button
                        className="gameButton"
                        type="button"
                        data-testid="spockButton"
                        onClick={() => checkResult(choicesList[4].id)}
                    >
                        <img
                            className="gameImg"
                            src={choicesList[4].imageUrl}
                            alt={choicesList[4].id}
                            key={choicesList[4].id}
                        />
                    </button>
                </>
            )}
